      ...
      >
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-[1600px] flex-col gap-10 px-0 pb-24 pt-24 md:grid md:grid-cols-[0.6fr_1.4fr] md:gap-16 md:px-12">
          ...
          <div className="relative hidden md:block">
            ...
            <div
              className={`absolute -left-12 bottom-20 z-40 overflow-hidden rounded-3xl border border-gold/20 bg-card/95 shadow-[0_20px_50px_rgba(0,0,0,0.15)] backdrop-blur-3xl transition-all duration-800 ease-[cubic-bezier(0.23,1,0.32,1)] min-w-[320px] ${
                cardVisible
